...
var CustomCommandsConfig_1 = __webpack_require__(77);
...
var Exports_1 = __webpack_require__(84);
...
(function (PropertyId) {
     ...
     */
    PropertyId[PropertyId["Conversation_Speech_Activity_Template"] = 39] = "Conversation_Speech_Activity_Template";
    /**
     * The Cognitive Services Speech Service host (url). Under normal circumstances, you shouldn't have to use this property directly.
     * Instead, use [[SpeechConfig.fromHost]].
     */
    PropertyId[PropertyId["SpeechServiceConnection_Host"] = 40] = "SpeechServiceConnection_Host";
    /**
     * Set the host for service calls to the Conversation Translator REST management and websocket calls.
     */
    PropertyId[PropertyId["ConversationTranslator_Host"] = 41] = "ConversationTranslator_Host";
    /**
     * Optionally set the the host's display name.
     * Used when joining a conversation.
     */
    PropertyId[PropertyId["ConversationTranslator_Name"] = 42] = "ConversationTranslator_Name";
    /**
     * Optionally set a value for the X-CorrelationId request header.
     * Used for troubleshooting errors in the server logs. It should be a valid guid.
     */
    PropertyId[PropertyId["ConversationTranslator_CorrelationId"] = 43] = "ConversationTranslator_CorrelationId";
    /**
     * Set the conversation token to be sent to the speech service. This enables the
     * service to service call from the speech service to the Conversation Translator service for relaying
     * recognitions. For internal use.
     */
    PropertyId[PropertyId["ConversationTranslator_Token"] = 44] = "ConversationTranslator_Token";
...
Object.defineProperty(exports, "__esModule", { value: true });
var Conversation_1 = __webpack_require__(85);
exports.Conversation = Conversation_1.Conversation;
var ConversationExpirationEventArgs_1 = __webpack_require__(86);
exports.ConversationExpirationEventArgs = ConversationExpirationEventArgs_1.ConversationExpirationEventArgs;
var ConversationParticipantsChangedEventArgs_1 = __webpack_require__(87);
...
var ConversationTranslationCanceledEventArgs_1 = __webpack_require__(88);
...
var Conversation = /** @class */ (function () {
    ...
    Conversation.createConversationAsync = function (speechConfig, cb, err) {
        ...
        var conversationImpl = new Exports_1.ConversationImpl(speechConfig);
...
var Contracts_1 = __webpack_require__(32);
var Exports_2 = __webpack_require__(30);
var Exports_3 = __webpack_require__(84);
var SpeechState;
...
var ConversationTranslator = /** @class */ (function () {
    ...
    ConversationTranslator.prototype.joinConversationAsync = function (conversation, nickname, param1, param2, param3) {
        ...
        try {
            if (typeof conversation === "string") {
                ...
                this.privConversation = new Exports_1.ConversationImpl(this.privSpeechTranslationConfig);
    ...
    ConversationTranslator.prototype.fireCancelEvent = function (error) {
        ...
        try {
            if (!!this.canceled) {
                var cancelEvent = new Exports_3.ConversationTranslationCanceledEventArgs((_a = error === null || error === void 0 ? void 0 : error.reason) !== null && _a !== void 0 ? _a : Exports_2.CancellationReason.Error, (_b = error === null || error === void 0 ? void 0 : error.errorDetails) !== null && _b !== void 0 ? _b : error, (_c = error === null || error === void 0 ? void 0 : error.errorCode) !== null && _c !== void 0 ? _c : Exports_2.CancellationErrorCode.RuntimeError, undefined, error === null || error === void 0 ? void 0 : error.sessionId);
...
var Exports_3 = __webpack_require__(30);
var Exports_4 = __webpack_require__(25);
var SpeechConnectionMessage_Internal_1 = __webpack_require__(96);
...
var System = /** @class */ (function () {
    function System() {
        ...
        var SPEECHSDK_CLIENTSDK_VERSION = "1.10.0";
        this.name = "SpeechSDK";
...
Object.defineProperty(exports, "__esModule", { value: true });
var Exports_1 = __webpack_require__(4);
var RecognitionEvents_1 = __webpack_require__(94);
var ServiceTelemetryListener_Internal_1 = __webpack_require__(115);
...
var Exports_2 = __webpack_require__(4);
var Exports_3 = __webpack_require__(30);
var DialogServiceTurnStateManager_1 = __webpack_require__(119);
var Exports_4 = __webpack_require__(25);
var ActivityResponsePayload_1 = __webpack_require__(121);
var SpeechConnectionMessage_Internal_1 = __webpack_require__(96);
var DialogServiceAdapter = /** @class */ (function (_super) {
    ...
    DialogServiceAdapter.prototype.sendWaveHeader = function (connection) {
        var _this = this;
        return this.audioSource.format.onSuccessContinueWithPromise(function (format) {
            return connection.send(new SpeechConnectionMessage_Internal_1.SpeechConnectionMessage(Exports_2.MessageType.Binary, "audio", _this.privDialogRequestSession.requestId, null, format.header));
        });
    };
    // Establishes a websocket connection to the end point.
...
Object.defineProperty(exports, "__esModule", { value: true });
var Error_1 = __webpack_require__(10);
var DialogServiceTurnState_1 = __webpack_require__(120);
...
// Licensed under the MIT license.
Object.defineProperty(exports, "__esModule", { value: true });
var ConversationImpl_1 = __webpack_require__(124);
exports.ConversationImpl = ConversationImpl_1.ConversationImpl;
var ConversationManager_1 = __webpack_require__(125);
exports.ConversationManager = ConversationManager_1.ConversationManager;
var ConversationUtils_1 = __webpack_require__(126);
exports.ConversationTranslatorConfig = ConversationUtils_1.ConversationTranslatorConfig;
var ConversationTranslatorRecognizer_1 = __webpack_require__(127);
exports.ConversationTranslatorRecognizer = ConversationTranslatorRecognizer_1.ConversationTranslatorRecognizer;
var ConversationTranslatorEventArgs_1 = __webpack_require__(133);
...
var ConversationTranslatorInterfaces_1 = __webpack_require__(134);
...
var Contracts_1 = __webpack_require__(32);
var Exports_1 = __webpack_require__(30);
var Exports_2 = __webpack_require__(123);
var ConversationImpl = /** @class */ (function (_super) {
    ...
    function ConversationImpl(speechConfig) {
        ...
        _this.onParticipantUpdateCommandReceived = function (r, e) {
            ...
            try {
                ...
                if (updatedParticipant !== undefined) {
                    switch (e.key) {
                        case Exports_2.ConversationTranslatorCommandTypes.changeNickname:
                            updatedParticipant.displayName = e.value;
                            break;
                        case Exports_2.ConversationTranslatorCommandTypes.setUseTTS:
                            updatedParticipant.useTts = e.value;
                            break;
                        case Exports_2.ConversationTranslatorCommandTypes.setProfanityFiltering:
                            updatedParticipant.profanity = e.value;
                            break;
                        case Exports_2.ConversationTranslatorCommandTypes.setMute:
                            updatedParticipant.isMuted = e.value;
                            break;
                        case Exports_2.ConversationTranslatorCommandTypes.setTranslateToLanguages:
                    ...
                    if (!!((_a = _this.privConversationTranslator) === null || _a === void 0 ? void 0 : _a.participantsChanged)) {
                        (_b = _this.privConversationTranslator) === null || _b === void 0 ? void 0 : _b.participantsChanged(_this.privConversationTranslator, new Exports_1.ConversationParticipantsChangedEventArgs(Exports_1.ParticipantChangedReason.Updated, [_this.toParticipant(updatedParticipant)], e.sessionId));
                    }
                }
            }
            catch (e) {
        ...
        _this.onMuteAllCommandReceived = function (r, e) {
            ...
            try {
                ...
                if (!!((_a = _this.privConversationTranslator) === null || _a === void 0 ? void 0 : _a.participantsChanged)) {
                    (_b = _this.privConversationTranslator) === null || _b === void 0 ? void 0 : _b.participantsChanged(_this.privConversationTranslator, new Exports_1.ConversationParticipantsChangedEventArgs(Exports_1.ParticipantChangedReason.Updated, _this.toParticipants(false), e.sessionId));
                }
            }
            catch (e) {
                //
        ...
        _this.onParticipantJoinCommandReceived = function (r, e) {
            ...
            try {
                ...
                if (newParticipant !== undefined) {
                    if (!!((_a = _this.privConversationTranslator) === null || _a === void 0 ? void 0 : _a.participantsChanged)) {
                        (_b = _this.privConversationTranslator) === null || _b === void 0 ? void 0 : _b.participantsChanged(_this.privConversationTranslator, new Exports_1.ConversationParticipantsChangedEventArgs(Exports_1.ParticipantChangedReason.JoinedConversation, [_this.toParticipant(newParticipant)], e.sessionId));
                    }
                }
            }
            catch (e) {
            ...
            try {
                ...
                if (ejectedParticipant !== undefined) {
                    ...
                    if (!!((_a = _this.privConversationTranslator) === null || _a === void 0 ? void 0 : _a.participantsChanged)) {
                        ...
                        (_b = _this.privConversationTranslator) === null || _b === void 0 ? void 0 : _b.participantsChanged(_this.privConversationTranslator, new Exports_1.ConversationParticipantsChangedEventArgs(Exports_1.ParticipantChangedReason.LeftConversation, [_this.toParticipant(ejectedParticipant)], e.sessionId));
                    }
                }
            }
            catch (e) {
        ...
        _this.onTranslationReceived = function (r, e) {
            ...
            try {
                switch (e.command) {
                    case Exports_2.ConversationTranslatorMessageTypes.final:
                        if (!!((_a = _this.privConversationTranslator) === null || _a === void 0 ? void 0 : _a.transcribed)) {
                            (_b = _this.privConversationTranslator) === null || _b === void 0 ? void 0 : _b.transcribed(_this.privConversationTranslator, new Exports_1.ConversationTranslationEventArgs(e.payload, undefined, e.sessionId));
                        }
                        break;
                    case Exports_2.ConversationTranslatorMessageTypes.partial:
                        if (!!((_c = _this.privConversationTranslator) === null || _c === void 0 ? void 0 : _c.transcribing)) {
                            (_d = _this.privConversationTranslator) === null || _d === void 0 ? void 0 : _d.transcribing(_this.privConversationTranslator, new Exports_1.ConversationTranslationEventArgs(e.payload, undefined, e.sessionId));
                        }
                        break;
                    case Exports_2.ConversationTranslatorMessageTypes.instantMessage:
                        if (!!((_e = _this.privConversationTranslator) === null || _e === void 0 ? void 0 : _e.textMessageReceived)) {
                            (_f = _this.privConversationTranslator) === null || _f === void 0 ? void 0 : _f.textMessageReceived(_this.privConversationTranslator, new Exports_1.ConversationTranslationEventArgs(e.payload, undefined, e.sessionId));
                        }
                        break;
                }
            }
        ...
        _this.onParticipantsListReceived = function (r, e) {
            ...
            try {
                ...
                if (!!((_a = _this.privConversationTranslator) === null || _a === void 0 ? void 0 : _a.participantsChanged)) {
                    (_b = _this.privConversationTranslator) === null || _b === void 0 ? void 0 : _b.participantsChanged(_this.privConversationTranslator, new Exports_1.ConversationParticipantsChangedEventArgs(Exports_1.ParticipantChangedReason.JoinedConversation, _this.toParticipants(true), e.sessionId));
                }
                // if this is the host, update the nickname if needed
                if (_this.me.isHost) {
                    var nickname = _this.privConversationTranslator.properties.getProperty(Exports_1.PropertyId.ConversationTranslator_Name);
        ...
        _this.privProperties = new Exports_1.PropertyCollection();
        _this.privManager = new Exports_2.ConversationManager();
        // check the speech language
        var language = speechConfig.getProperty(Exports_1.PropertyId[Exports_1.PropertyId.SpeechServiceConnection_RecoLanguage]);
        if (!language) {
            speechConfig.setProperty(Exports_1.PropertyId[Exports_1.PropertyId.SpeechServiceConnection_RecoLanguage], Exports_2.ConversationTranslatorConfig.defaultLanguageCode);
        }
        _this.privLanguage = speechConfig.getProperty(Exports_1.PropertyId[Exports_1.PropertyId.SpeechServiceConnection_RecoLanguage]);
        // check the target language(s)
        if (speechConfig.targetLanguages.length === 0) {
            speechConfig.addTargetLanguage(_this.privLanguage);
        }
        // check the profanity setting: speech and conversationTranslator should be in sync
        var profanity = speechConfig.getProperty(Exports_1.PropertyId[Exports_1.PropertyId.SpeechServiceResponse_ProfanityOption]);
        if (!profanity) {
            speechConfig.setProfanity(Exports_1.ProfanityOption.Masked);
        }
        // check the nickname: it should pass this regex: ^\w+([\s-][\w\(\)]+)*$"
        // TODO: specify the regex required. Nicknames must be unique or get the duplicate nickname error
        // TODO: check what the max length is and if a truncation is required or if the service handles it without an error
        var hostNickname = speechConfig.getProperty(Exports_1.PropertyId[Exports_1.PropertyId.ConversationTranslator_Name]);
        if (hostNickname === undefined || hostNickname === null || hostNickname.length <= 1 || hostNickname.length > 50) {
            hostNickname = "Host";
        }
        speechConfig.setProperty(Exports_1.PropertyId[Exports_1.PropertyId.ConversationTranslator_Name], hostNickname);
        ...
        _this.privProperties = configImpl.properties.clone();
        _this.privIsConnected = false;
        _this.privParticipants = new Exports_2.InternalParticipants();
    ...
    ConversationImpl.prototype.createConversationAsync = function (cb, err) {
        ...
        try {
            if (!!this.privConversationRecognizer) {
                this.handleError(new Error(Exports_2.ConversationTranslatorConfig.strings.permissionDeniedStart), err);
            }
            this.privManager.createOrJoin(this.privProperties, undefined, (function (room) {
                if (!room) {
                    _this.handleError(new Error(Exports_2.ConversationTranslatorConfig.strings.permissionDeniedConnect), err);
                }
                _this.privRoom = room;
                _this.handleCallback(cb, err);
            }), (function (error) {
    ...
    ConversationImpl.prototype.startConversationAsync = function (cb, err) {
        ...
        try {
            ...
            Contracts_1.Contracts.throwIfNullOrUndefined(this.privRoom, Exports_2.ConversationTranslatorConfig.strings.permissionDeniedConnect);
            // connect to the conversation websocket
            this.privParticipants.meId = this.privRoom.participantId;
            this.privConversationRecognizer = new Exports_2.ConversationTranslatorRecognizer(this.privConfig);
            this.privConversationRecognizer.conversation = this.privRoom;
            this.privConversationRecognizerConnection = Exports_1.Connection.fromRecognizer(this.privConversationRecognizer);
    ...
    ConversationImpl.prototype.joinConversationAsync = function (conversationId, nickname, lang, cb, err) {
        ...
        try {
            ...
            // }
            Contracts_1.Contracts.throwIfNullOrWhitespace(conversationId, Exports_2.ConversationTranslatorConfig.strings.invalidArgs.replace("{arg}", "conversationId"));
            Contracts_1.Contracts.throwIfNullOrWhitespace(nickname, Exports_2.ConversationTranslatorConfig.strings.invalidArgs.replace("{arg}", "nickname"));
            Contracts_1.Contracts.throwIfNullOrWhitespace(lang, Exports_2.ConversationTranslatorConfig.strings.invalidArgs.replace("{arg}", "language"));
            // join the conversation
            this.privManager.createOrJoin(this.privProperties, conversationId, (function (room) {
                Contracts_1.Contracts.throwIfNullOrUndefined(room, Exports_2.ConversationTranslatorConfig.strings.permissionDeniedConnect);
                _this.privRoom = room;
    ...
    ConversationImpl.prototype.deleteConversationAsync = function (cb, err) {
        var _this = this;
        try {
            Contracts_1.Contracts.throwIfNullOrUndefined(this.privProperties, Exports_2.ConversationTranslatorConfig.strings.permissionDeniedConnect);
            Contracts_1.Contracts.throwIfNullOrWhitespace(this.privRoom.token, Exports_2.ConversationTranslatorConfig.strings.permissionDeniedConnect);
    ...
    ConversationImpl.prototype.lockConversationAsync = function (cb, err) {
        ...
        try {
            ...
            Contracts_1.Contracts.throwIfNullOrUndefined(this.privRoom, Exports_2.ConversationTranslatorConfig.strings.permissionDeniedSend);
            if (!this.canSendAsHost) {
                this.handleError(new Error(Exports_2.ConversationTranslatorConfig.strings.permissionDeniedConversation.replace("{command}", "lock")), err);
            }
    ...
    ConversationImpl.prototype.muteAllParticipantsAsync = function (cb, err) {
        ...
        try {
            Contracts_1.Contracts.throwIfDisposed(this.privIsDisposed);
            Contracts_1.Contracts.throwIfDisposed(this.privConversationRecognizer.isDisposed());
            Contracts_1.Contracts.throwIfNullOrUndefined(this.privConversationRecognizer, Exports_2.ConversationTranslatorConfig.strings.permissionDeniedSend);
            Contracts_1.Contracts.throwIfNullOrUndefined(this.privRoom, Exports_2.ConversationTranslatorConfig.strings.permissionDeniedSend);
            // check the user's permissions
            if (!this.canSendAsHost) {
                this.handleError(new Error(Exports_2.ConversationTranslatorConfig.strings.permissionDeniedConversation.replace("{command}", "mute")), err);
            }
    ...
    ConversationImpl.prototype.muteParticipantAsync = function (userId, cb, err) {
        ...
        try {
            Contracts_1.Contracts.throwIfDisposed(this.privIsDisposed);
            Contracts_1.Contracts.throwIfDisposed(this.privConversationRecognizer.isDisposed());
            Contracts_1.Contracts.throwIfNullOrWhitespace(userId, Exports_2.ConversationTranslatorConfig.strings.invalidArgs.replace("{arg}", "userId"));
            Contracts_1.Contracts.throwIfNullOrUndefined(this.privRoom, Exports_2.ConversationTranslatorConfig.strings.permissionDeniedSend);
            // check the connection is open (host + participant can perform the mute command)
            if (!this.canSend) {
                this.handleError(new Error(Exports_2.ConversationTranslatorConfig.strings.permissionDeniedSend), err);
            }
            // if not host, check the participant is not muting another participant
            if (!this.me.isHost && this.me.id !== userId) {
                this.handleError(new Error(Exports_2.ConversationTranslatorConfig.strings.permissionDeniedParticipant.replace("{command}", "mute")), err);
            }
            // check the user exists
            var exists = this.privParticipants.getParticipantIndex(userId);
            if (exists === -1) {
                this.handleError(new Error(Exports_2.ConversationTranslatorConfig.strings.invalidParticipantRequest), err);
            }
    ...
    ConversationImpl.prototype.removeParticipantAsync = function (userId, cb, err) {
        ...
        try {
            ...
            Contracts_1.Contracts.throwIfNullOrUndefined(this.privRoom, Exports_2.ConversationTranslatorConfig.strings.permissionDeniedSend);
            if (!this.canSendAsHost) {
                this.handleError(new Error(Exports_2.ConversationTranslatorConfig.strings.permissionDeniedParticipant.replace("{command}", "remove")), err);
            }
            var participantId_1 = "";
            ...
            Contracts_1.Contracts.throwIfNullOrWhitespace(participantId_1, Exports_2.ConversationTranslatorConfig.strings.invalidArgs.replace("{arg}", "userId"));
    ...
    ConversationImpl.prototype.unlockConversationAsync = function (cb, err) {
        ...
        try {
            ...
            Contracts_1.Contracts.throwIfNullOrUndefined(this.privRoom, Exports_2.ConversationTranslatorConfig.strings.permissionDeniedSend);
            if (!this.canSendAsHost) {
                this.handleError(new Error(Exports_2.ConversationTranslatorConfig.strings.permissionDeniedConversation.replace("{command}", "unlock")), err);
            }
    ...
    ConversationImpl.prototype.unmuteAllParticipantsAsync = function (cb, err) {
        ...
        try {
            ...
            Contracts_1.Contracts.throwIfNullOrUndefined(this.privRoom, Exports_2.ConversationTranslatorConfig.strings.permissionDeniedSend);
            if (!this.canSendAsHost) {
                this.handleError(new Error(Exports_2.ConversationTranslatorConfig.strings.permissionDeniedConversation.replace("{command}", "unmute all")), err);
            }
    ...
    ConversationImpl.prototype.sendTextMessageAsync = function (message, cb, err) {
        ...
        try {
            Contracts_1.Contracts.throwIfDisposed(this.privIsDisposed);
            Contracts_1.Contracts.throwIfDisposed(this.privConversationRecognizer.isDisposed());
            Contracts_1.Contracts.throwIfNullOrWhitespace(message, Exports_2.ConversationTranslatorConfig.strings.invalidArgs.replace("{arg}", "message"));
            Contracts_1.Contracts.throwIfNullOrUndefined(this.privRoom, Exports_2.ConversationTranslatorConfig.strings.permissionDeniedSend);
            if (!this.canSend) {
                this.handleError(new Error(Exports_2.ConversationTranslatorConfig.strings.permissionDeniedSend), err);
            }
            // TODO: is a max length check required?
            if (message.length > Exports_2.ConversationTranslatorConfig.textMessageMaxLength) {
                this.handleError(new Error(Exports_2.ConversationTranslatorConfig.strings.invalidArgs.replace("{arg}", "message length")), err);
            }
    ...
    ConversationImpl.prototype.toParticipant = function (p) {
        return new Exports_1.Participant(p.id, p.avatar, p.displayName, p.isHost, p.isMuted, p.isUsingTts, p.preferredLanguage);
    };
    return ConversationImpl;
}(Exports_1.Conversation));
...
var Contracts_1 = __webpack_require__(32);
var Exports_2 = __webpack_require__(30);
var ConversationConnectionFactory_1 = __webpack_require__(128);
var ConversationServiceAdapter_1 = __webpack_require__(131);
var ConversationTranslatorInterfaces_1 = __webpack_require__(134);
var ConversationUtils_1 = __webpack_require__(126);
/**
...
var ConnectionFactoryBase_1 = __webpack_require__(60);
var ConversationUtils_1 = __webpack_require__(126);
var ConversationWebsocketMessageFormatter_1 = __webpack_require__(129);
/**
...
Object.defineProperty(exports, "__esModule", { value: true });
var Exports_1 = __webpack_require__(4);
var ConversationConnectionMessage_1 = __webpack_require__(130);
/**
...
var Exports_3 = __webpack_require__(25);
var ConversationConnectionMessage_1 = __webpack_require__(130);
var ConversationRequestSession_1 = __webpack_require__(132);
var ConversationTranslatorEventArgs_1 = __webpack_require__(133);
var ConversationTranslatorInterfaces_1 = __webpack_require__(134);
var Exports_4 = __webpack_require__(135);
/***
...
Object.defineProperty(exports, "__esModule", { value: true });
var CommandResponsePayload_1 = __webpack_require__(136);
exports.CommandResponsePayload = CommandResponsePayload_1.CommandResponsePayload;
var ParticipantResponsePayload_1 = __webpack_require__(137);
...
var TranslationResponsePayload_1 = __webpack_require__(138);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Exports_1 = __webpack_require__(4);
var WebsocketMessageAdapter_1 = __webpack_require__(142);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Exports_1 = __webpack_require__(4);
var HttpsProxyAgent = __webpack_require__(149);
var ws = __webpack_require__(150);
var ocsp = __webpack_require__(151);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(143), __webpack_require__(144).Buffer))
